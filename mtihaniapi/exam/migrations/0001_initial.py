...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('Generating', 'Generating'), ('Failed', 'Failed'), ('Upcoming', 'Upcoming'), ('Ongoing', 'Ongoing'), ('Grading', 'Grading'), ('Complete', 'Complete'), ('Archive', 'Archive')], default='Upcoming', max_length=15)),
